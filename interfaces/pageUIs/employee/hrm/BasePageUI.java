...
public class BasePageUI {
	...
	public static final String TEXBOX_BY_ID = "//input[@id='%s']";
	public static final String IMG_PICKER = "//input[@id='%s']/following-sibling::img";
	...
	public static final String SUCCESS_MESSAGE_NAME = "//div[@class='inner']/div[contains(text(),'%s')]";
